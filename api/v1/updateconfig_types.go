...
// UpdateConfig is the Schema for the updateconfigs API
...
// UpdateConfigList contains a list of UpdateConfig
...
func init() {
	SchemeBuilder.Register(&UpdateConfig{}, &UpdateConfigList{})
}
